...
function TwitchAnimations(): JSX.Element {
  ...
  const [username, setUsername] = useState<string>(searchParams.get('username') || 'StreamerName');
  ...
  return (
    <>
      ...
      <section className="anim-seo">
        ...
        <p>
          Create <strong>fake Twitch alerts</strong> and <strong>animated bit donations</strong>{' '}
          instantly. Whether you need a "Cheered 10000 bits" notification for a video edit or a{' '}
          <strong>transparent background alert</strong> for your OBS overlay, our{' '}
          <strong>Alert Animator</strong> delivers high-quality, authentic Twitch visuals.
        </p>
        ...
        <div className="anim-seo-grid">
          <div className="anim-seo-item">
            ...
            <p>
              We use the official animated gem assets (Gray, Purple, Green, Blue, Red) to ensure
              your alerts look exactly like the real thing. Perfect for simulating hype moments in
              your videos.
            </p>
          </div>
          <div className="anim-seo-item">
            ...
            <p>
              ...
              The alerts render at 60fps with full transparency support, no green screen removal
              required!
            </p>
          </div>
          <div className="anim-seo-item">
            ...
            <p>
              Need a thumbnail? Download a high-resolution PNG of the alert frame to use in your
              YouTube thumbnails or social media posts.
            </p>
          </div>
        </div>
      </section>
