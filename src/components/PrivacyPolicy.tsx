  ...
  return (
    <div className="privacy-container">
      <div className="privacy-content">
        ...
        <p>
          We do not collect any personal data directly from you when you use our
          Twitch Message Creator tool. The tool runs locally in your browser and
          does not send your generated messages or inputs to our servers.
        </p>
        ...
        <p>
          ...
          us by visiting the main page of our website.
        </p>

        <h2>Ezoic Privacy Policy</h2>
        <p>
          This site uses Ezoic to manage advertising and analytics. For more
          information about how Ezoic collects and uses data, please see their
