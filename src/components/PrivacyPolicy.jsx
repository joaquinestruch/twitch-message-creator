    ...
    return (
        <div className="privacy-container">
            <div className="privacy-content">
                ...
                <p>We do not collect any personal data directly from you when you use our Twitch Message Creator tool. The tool runs locally in your browser and does not send your generated messages or inputs to our servers.</p>
